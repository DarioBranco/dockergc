...
basedir = "/shared/research_data_new"
...
if __name__ == "__main__":
    ...
    server.recursive_download('/shared/research_data_new/devices', modelMap, database_file_name, 0)
    server.recursive_download('/shared/research_data_new/individual_entities', individualMap, database_file_name, 1)
    server.recursive_download('/shared/research_data_new/recordings_logs', None, database_file_name, 2)
    server.disconnect()
