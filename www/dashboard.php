...
<head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
        ...
        <script src="http://localhost:8080/assets/bootstrap/js/bootstrap.min.js"></script>
  ...
  <script src="http://localhost:8080/assets/js/popper.js"  crossorigin="anonymous"></script>
    ...
    <script src="http://localhost:8080/assets/bootstrap/css/bootstrap.min.css"></script>
  ...
  if(!empty($_GET["done"]) && isset($_GET["done"]) )
    {
            ...
            $data = [
                ...
                ["KPI_ID" => "GC5.14.76", "KPIvalue" => $the_big_array[16][0]],
                ["KPI_ID" => "GC5.14.9", "KPIvalue" => $the_big_array[17][0]],
				["KPI_ID" => "GC5.14.1", "KPIvalue" => $the_big_array[18][0]],
                ["KPI_ID" => "GC5.14.2", "KPIvalue" => $the_big_array[19][0]],
				["KPI_ID" => "GC5.6.1", "KPIvalue" => $the_big_array[20][0]],
				["KPI_ID" => "GC5.6.2", "KPIvalue" => $the_big_array[21][0]],
				["KPI_ID" => "GC5.8.1", "KPIvalue" => $the_big_array[22][0]],
				["KPI_ID" => "GC5.8.2", "KPIvalue" => $the_big_array[23][0]],
				["KPI_ID" => "GC5.9", "KPIvalue" => $the_big_array[25][0]],
				["KPI_ID" => "GC5.12", "KPIvalue" => $the_big_array[24][0]]
            ];
	...
	<script>
		if(window.location.href == "http://localhost:8080/dashboard.php"){
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary2 p-0" style="background-color: #599f4f;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="http://localhost:8080/dashboard.php?done=true&lastev=true"><i class="fas fa-hand-point-left"></i><span>Last Evaluation</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
				...
				<div id="mySidenav" class="sidenav">
				  ...
				  <h1 > The energy EVs are charged with per connected time unit. </h1>
				  				  <hr class="dashed">
				  			  <li>GC5.3.4</li>
				  <h1 > Number of charging sessions during a specific time span  </h1>
				  ...
				  <hr class="dashed">
				  			  <li>GC5.5.2</li>
				  <h1 > Share of charging sessions where EVs are charged according to the charging demand </h1>
				  <hr class="dashed">
				  			  <li>GC5.5.3</li>
				  <h1 > Share of booked time slots that are not used   </h1>
				  
				  				  <hr class="dashed">
				  			  <li>GC5.5.3</li>
				  <h1 > Average delay in plug-in time. </h1>
				  				  <hr class="dashed">
				  			  <li>GC5.5.3</li>
				  <h1 > Share of sessions that are not finished (plug out) in time.</h1>
				  				  <hr class="dashed">
				  			  <li>GC5.5.3</li>
				  <h1 > Average delay in plug-out time. </h1>
		  ...
		  <script language = "JavaScript">
						...
						var getResponse = function () {
							var res = $.ajax({
								url: "http://parsec2.unicampania.it:5437/getstatus?loggedin="+<?php echo $_SESSION["id"]?>,
								async: false,
								dataType: 'json'
							}).responseJSON;
							if(res["isDone"]){	
					    ...
					    function modal(){
							...
							params['evaldir'] = '<?php echo $_SESSION["evaldir"]?>';
							console.log('param');
							console.log(params['evaldir']);
							if(!("day" in params) || !("lastday" in params) || !("id_pilot" in params)){
							  ...
							  console.log("http://parsec2.unicampania.it:5437/newevaluation?day1="+String(day[0])+"&day2="+String(lastday[0])+"&id_pilot="+String(id_pilot)+"&loggedin="+<?php echo $_SESSION["id"]?>+"&month1="+String(day[1])+"&year1="+String(day[2])+"&month2="+String(lastday[1])+"&year2="+String(lastday[2])+"&locationid="+String(locid));
							    $.ajax({
									  url: "http://parsec2.unicampania.it:5437/newevaluation?day1="+String(day[0])+"&day2="+String(lastday[0])+"&id_pilot="+String(id_pilot)+"&loggedin="+<?php echo $_SESSION["id"]?>+"&month1="+String(day[1])+"&year1="+String(day[2])+"&month2="+String(lastday[1])+"&year2="+String(lastday[2])+"&locationid="+String(locid)+"&evaldir="+String(evalid),
									  type: "GET",
				...
				<script>
					...
					const selectElement = document.getElementById('select_dir');
					 ...
					 var valDef = 0;
					  if(event.target.value == 1){
						  valDef = 1;
							...
							result.textContent = 'You have selected the Real Mode';

					  }
					  else{
						  valDef = 2;

							result.textContent = 'You have selected the Test Mode';
					  }
					      $.ajax({
                          ...
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    ...
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=3){echo $the_big_array[2][0];}else{echo '0';}?> kW</span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span><?php if(count($the_big_array)>=7){echo $the_big_array[7][0];}else{echo '0';}?> min</span></div>
                                            </div>
                          ...
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    ...
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=3){echo $the_big_array[10][0];}else{echo '0';}?> kWh</span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> 
                              </div>
                          </div>
                          ...
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    ...
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=15){echo $the_big_array[15][0].' ';}else{echo '0 ';}?> kW</span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                  ...
                  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-primary py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>GC5.14.1 Self-Consumption</span></div>
                  ...
                  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-success py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>GC5.14.2 Self-Sufficiency</span></div>
				  ...
				  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-success py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>GC5.6.4</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=15){echo $the_big_array[20][0].' ';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                      ...
                      <div class="card shadow border-left-success py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>GC5.6.6</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=15){echo $the_big_array[21][0].' ';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                  ...
                  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-primary py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>GC5.8.1</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=14){echo $the_big_array[22][0].'';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                  ...
                  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-success py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>GC5.8.2</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=15){echo $the_big_array[23][0].' ';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                      ...
                      <div class="card shadow border-left-primary py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>GC5.9 Energy Mix</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=14){echo $the_big_array[25][0].'';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
                  ...
                  <div class="col-md-6 col-xl-3 mb-4">
                      <div class="card shadow border-left-success py-2">
                          <div class="card-body">
                              <div class="row align-items-center no-gutters">
                                  <div class="col mr-2">
                                    <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>GC5.12 CO2 Emissions</span></div>
                                    <div class="text-dark font-weight-bold h5 mb-0"><span><?php if(count($the_big_array)>=15){echo $the_big_array[24][0].' ';}else{echo '0';}?></span></div>
                                  </div>
                                <!--  <div class="col-auto"><i class="fas fa-clipboard-list fa-2x text-gray-300"></i></div> -->
                              </div>
                          </div>
             ...
             <!--   <div class="row">
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-area"><canvas data-bs-chart="{&quot;type&quot;:&quot;doughnut&quot;,&quot;data&quot;:{&quot;labels&quot;:[&quot;Self-Consumption&quot;,&quot;Grid-Consumption&quot;],&quot;datasets&quot;:[{&quot;label&quot;:&quot;&quot;,&quot;backgroundColor&quot;:[&quot;#4e73df&quot;,&quot;#1cc88a&quot;,&quot;#36b9cc&quot;],&quot;borderColor&quot;:[&quot;#ffffff&quot;,&quot;#ffffff&quot;,&quot;#ffffff&quot;],&quot;data&quot;:[&quot;<?php echo($the_big_array[16][0]);?>&quot;,&quot;<?php echo((string)(100-$the_big_array[16][0]));?>&quot;]}]},&quot;options&quot;:{&quot;maintainAspectRatio&quot;:false,&quot;legend&quot;:{&quot;display&quot;:false},&quot;title&quot;:{}}}"></canvas></div>
                            <div
        ...
        <div class="row">
            <div class="col-lg-7 col-xl-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
					 <div class="btn btn-success btn-sm d-none d-sm-inline-block" onclick="downloadpngOne()" role="button" href="#" ><i class="fas fa-download fa-sm text-white-50"></i> Download Chart</div> 
                      ...
                      <div class="col-md-12"><canvas id="myChart2" ></canvas></div>
                             ...
                             datasets: [{
											...
											function downloadpngOne(){

													var a = document.createElement('a');
													a.href = myLineChart.toBase64Image();
													a.download = 'firstchart.png';
